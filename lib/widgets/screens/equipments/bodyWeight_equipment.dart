...
class BodyPartWithBodyWeight extends StatefulWidget {
  @override
  _BodyPartWithBodyWeightState createState() => _BodyPartWithBodyWeightState();
}

class _BodyPartWithBodyWeightState extends State<BodyPartWithBodyWeight> {
  @override
  void initState() {
    super.initState();
