...
class BodyPartWithBarbell extends StatefulWidget {
  @override
  _BodyPartWithBarbellState createState() => _BodyPartWithBarbellState();
}

class _BodyPartWithBarbellState extends State<BodyPartWithBarbell> {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, state) {
          if (state is ExercisesIsLoading) {
            ...
            final barbellExercises = state.exercises
                .where((exercise) => exercise.equipment.toLowerCase() == 'barbell')
                .toList();
