...
class BodyPartWithMachine extends StatefulWidget {
  @override
  _BodyPartWithMachineState createState() => _BodyPartWithMachineState();
}

class _BodyPartWithMachineState extends State<BodyPartWithMachine> {
  @override
  void initState() {
    super.initState();
    // Call the Cubit method to fetch exercises
        ...
        builder: (context, state) {
          if (state is ExercisesIsLoading) {
            ...
            final barbellExercises = state.exercises
                .where((exercise) => exercise.equipment.toLowerCase() == 'leverage machine')
                .toList();
